...
filename='../data/Figure_1.csv' #data from general population survey USA (annual data are available)
f=open(filename, 'r')
...
plt.plot(quant,mg,'o-',markeredgecolor='black',ms=8,lw=2,label='average margin',alpha=0.8)
#plt.plot(pbrack,ieplus,'k-',alpha=0.4)
#plt.plot(pbrack,ieminus,'k-',alpha=0.4)

plt.ylim(0.01,0.02)
xlabel('Share of neighborhood population born in non-Nordic/EU15 countries',fontsize=11)
